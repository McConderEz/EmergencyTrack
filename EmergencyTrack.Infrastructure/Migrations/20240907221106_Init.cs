...
namespace EmergencyTrack.Infrastructure.Mssql.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AmbulanceRequestCauseOfRecall",
                columns: table => new
                {
                    AmbulanceRequestsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CauseOfRecallsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmbulanceRequestCauseOfRecall", x => new { x.AmbulanceRequestsId, x.CauseOfRecallsId });
                    table.ForeignKey(
                        name: "FK_AmbulanceRequestCauseOfRecall_ambulance_requests_AmbulanceRequestsId",
                        column: x => x.AmbulanceRequestsId,
                        principalTable: "ambulance_requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmbulanceRequestCauseOfRecall_cause_of_recall_CauseOfRecallsId",
                        column: x => x.CauseOfRecallsId,
                        principalTable: "cause_of_recall",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceRequestCauseOfRecall_CauseOfRecallsId",
                table: "AmbulanceRequestCauseOfRecall",
                column: "CauseOfRecallsId");
